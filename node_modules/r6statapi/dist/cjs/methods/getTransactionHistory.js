...
exports.GetTransactionHistroy = void 0;
const constants_1 = require("../constants");
const helperFunctions_1 = require("../utils/helperFunctions");
const apiClient_1 = require("./apiClient");
const auth_1 = require("./auth");
const GetTransactionHistroy = async (profileId, limit) => {
    ...
    const body = [
        {
            ...
            query: constants_1.GraphQL_GetTransactionHistory,
        },
    ];
...
exports.GetTransactionHistroy = GetTransactionHistroy;
        ...
        if (itemDetails.trades && itemDetails.trades.nodes.length > 0) {
            itemDetails.trades.nodes.forEach(async (item) => {
                ...
                const transaction = {
                    ...
                    payment: await (0, helperFunctions_1.BuildPayment)(payment),
                };
