...
export type SortByOptions = 'Purchase available: high to low' | 'Purchase available: low to high' | 'Sale available: high to low' | 'Sale available: low to high' | 'Last sale price: high to low' | 'Last sale price: low to high' | 'Item names: A-Z' | 'Item names: Z-A';
...
export type Type = 'WeaponSkin' | 'CharacterHeadgear' | 'CharacterUniform' | 'WeaponAttachmentSkinSet' | 'Charm' | 'OperatorCardPortrait' | 'OperatorCardBackground' | 'DroneSkin' | 'GadgetSkin';
export type Season = 'Y1S1' | 'Y1S2' | 'Y1S3' | 'Y1S4' | 'Y2S1' | 'Y2S2' | 'Y2S3' | 'Y2S4' | 'Y3S1' | 'Y3S2' | 'Y3S3' | 'Y3S4' | 'Y4S1' | 'Y4S2' | 'Y4S3' | 'Y4S4' | 'Y5S1' | 'Y5S2' | 'Y5S3' | 'Y5S4' | 'Y6S1' | 'Y6S2' | 'Y6S3' | 'Y6S4' | 'Y7S1' | 'Y7S2' | 'Y7S3' | 'Y7S4' | 'Y8S1' | 'Y8S2' | 'Y8S3' | 'Y8S4' | 'Y9S1' | 'Y9S2' | 'Y9S3';
...
export declare enum EsportsTeams {
    '00Nation' = "00NATION",
    Astralis = "ATRALIS",
    'Chaos EC' = "CHAOS_EC",
    Cloud9 = "CLOUD9",
...
export declare const PurchaseAvailableHighLow: SortBy;
export declare const PurchaseAvailableLowHigh: SortBy;
export declare const SaleAvailableHighLow: SortBy;
export declare const SaleAvailableLowHigh: SortBy;
export declare const LastSalePriceHighLow: SortBy;
export declare const LastSalePriceLowHigh: SortBy;
export declare const ItemNamesDESC: SortBy;
export declare const ItemNamesASC: SortBy;
