import { GraphQL_BuyableItemQuery, GraphQL_SellableItemsQuery, UBI_APPID_Marketplace, UBI_LOCALECODE, UBI_MARKETPLACE_URI, UBI_REGIONID_MARKETPLACE, UBI_SESSIONID_MARKETPLACE, X_PLATFORM_APPID, } from '../constants';
import { BuildEsportTeams, BuildEvents, BuildItemRarity, BuildOperators, BuildOtherTypes, BuildWeapons, MapMarketData, ReturnSortBy, } from '../utils/helperFunctions';
import { ApiClient } from './apiClient';
import { CheckToken } from './auth';
export const AdvancedSearch = async (searchTerm, searchType, types, tags, sortBy, limit) => {
    ...
    const graphqlQuery = searchType === 'sell' ? GraphQL_SellableItemsQuery : GraphQL_BuyableItemQuery;
