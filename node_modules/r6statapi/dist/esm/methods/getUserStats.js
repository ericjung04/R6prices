...
import { RANKED_UBI_SPACEIDS, UBI_DATADEV_SESSIONID, UBI_DATADEV_URI, UBI_GETSTATS, } from '../constants';
import { GetUserByUserId } from './getUserByUserId';
export const GetUserStats = async (userId, platform, view, aggregation, gameMode, teamRole, season) => {
    ...
    const URI = UBI_DATADEV_URI +
        UBI_GETSTATS(userId, spaceId, platformTransformation, view, aggregation, gameMode, teamRole, season);
