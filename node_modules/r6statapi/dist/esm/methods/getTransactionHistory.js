import { GraphQL_GetTransactionHistory, UBI_APPID_Marketplace, UBI_LOCALECODE, UBI_MARKETPLACE_URI, UBI_REGIONID_MARKETPLACE, UBI_SESSIONID_MARKETPLACE, X_PLATFORM_APPID, } from '../constants';
import { BuildPayment, BuildPaymentOptions, BuildTradeItems } from '../utils/helperFunctions';
import { ApiClient } from './apiClient';
import { CheckToken } from './auth';
export const GetTransactionHistroy = async (profileId, limit) => {
