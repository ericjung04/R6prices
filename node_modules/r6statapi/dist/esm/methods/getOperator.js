...
import { UBI_RANKED_SESSIONID, UBI_DATADEV_APPID, UBI_DATADEV_URI, UBI_GETSTATS, RANKED_UBI_SPACEIDS, } from '../constants';
export const GetOperator = async (userId, platform, view, aggregation, gameMode, teamRole, season) => {
